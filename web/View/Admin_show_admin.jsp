...
<head>
    ...
    <link rel="stylesheet" href="css/Admin_show_admin.css">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            if(session.getAttribute("listAd")!=null)
                                            ad = (ArrayList<user>) session.getAttribute("listAd");
                                            for(user u : ad){
                                        %>
                                        <tr>
                                            <td data-label="STT"><%=u.getIdUser()%></td>
                                            <td data-label="Tên"><%=u.getFullname()%></td>
                                            <td data-label="Email"><%=u.getEmail()%></td>
                                            <td data-label="Sửa" class="right__iconTable">
                                                <form action="show_update_admin" method="get">
                                                    <input id="id_admin_update" name="idau" type="hidden" value="<%=u.getIdUser()%>">
                                                    <input type="submit" value="Sửa">
                                                </form>
                                            </td>
                                            <td class="right__iconTable">
                                                <form action="Del_admin" method="get">
                                                    <input id="id_admin_del" name="idad" type="hidden" value="<%=u.getIdUser()%>">
