		...
		<div class="row">
			<div class="content-body">
				<div class="page-title category-title">
						<h1 class="title-head"><a href="#">Thông tin khách hàng</a></h1>
				</div>
			</div>
			...
			<div class="block-body">
				<div class="block-account">
                    ...
                    <p>Xin chào, <span style="color:#f72b3f;"> <%=u.getFullname()%></span>&nbsp;!</p>
                    <ul>
                        <li>
                            <a disabled="disabled" href="#">Thông tin tài khoản</a>
                        </li>
                        <li>
	            ...
	            <div class="info-user">
	                <span class="title-user">Thông tin tài khoản</span>
	                <div class="form-info-user">
	                    <p><strong>Họ tên:</strong> <%=u.getFullname()%></p>
	                    <p><strong>Điện thoại:</strong> <%=u.getSdt()%></p>
	                    <p><strong>Email:</strong> <%=u.getEmail()%></p>
	                    <p><strong>Địa chỉ:</strong> <%=u.getAddress()%></p>
	                </div>
	            	<div class="btn-update">
	            		<a href="#"><form action="show_user_update_info" method="get">Sửa thông tin</form></a>
	            	</div>    
