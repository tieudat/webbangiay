                        ...
                        <div class="right__table">
                            <div class="right__tableWrapper">
                                <table>
                                    ...
                                    <tbody>
                                        <%
                                            ArrayList<user> cus = new ArrayList<user>();
                                            if(session.getAttribute("listCus")!=null)
                                            cus = (ArrayList<user>) session.getAttribute("listCus");
                                            for(user u : cus){
                                        %>
                                        <tr>
                                            ...
                                            <td data-label="Phone"><%=u.getSdt()%></td>
                                            <td data-label="Địa chỉ"><%=u.getAddress()%></td>          
                                            <td class="right__iconTable">
                                                <form action="Del_customer" method="get">
                                                    <input id="id_user_del" name="idud" type="hidden" value="<%=u.getIdUser()%>">
